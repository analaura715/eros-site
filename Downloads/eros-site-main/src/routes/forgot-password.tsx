...
export const Route = createFileRoute("/forgot-password")({
  head: () => ({ 
    meta: [
      { title: "Recuperar Senha | Venux CRM" }, 
    ...
    <div className="w-full min-h-screen flex font-sans bg-[#F7F8FA]">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-[#0D1B4C] flex-col justify-between p-14 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
           <VenuxLogo className="h-16 w-16 shrink-0 drop-shadow-[0_0_35px_rgba(0,181,226,0.6)]" />
           <span className="text-4xl font-extrabold tracking-tight text-white drop-shadow-md">venux</span>
        </div>
        ...
        <div className="relative z-10 max-w-[480px] mt-10">
          ...
          <p className="text-white/70 text-[17px] leading-relaxed mb-10 font-light">
            Esqueceu sua senha? Não se preocupe. Nosso sistema envia um link seguro diretamente para o seu e-mail.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-[#F7F8FA]">
        ...
        <div 
          className="w-full max-w-[440px] bg-white rounded-[24px] p-8 sm:p-10 shadow-[0_20px_60px_rgb(0,0,0,0.06)] border border-gray-100"
          style={{
            opacity: mounted ? 1 : 0,
        ...
        >
          ...
          <div className="flex flex-col mb-10">
            ...
            <p className="text-sm text-gray-500 font-medium">
              Informe seu e-mail cadastrado e nós enviaremos instruções de redefinição.
            </p>
          </div>
