...
export const Route = createFileRoute('/_comercial/empresas/')({
      ...
      <div className="relative overflow-hidden border-b px-6 py-8 bg-card flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Gerencie o portfólio de clientes ativos e realize a manutenção de dados.</p>
          </div>
        </div>
        <Button 
              ...
              <TableBody>
                {filtered.map((emp) => (
                  <TableRow 
                    ...
                    onClick={() => navigate({ to: `/empresas/${emp.id}` })}
                  >
