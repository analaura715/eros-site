...
export const Route = createFileRoute('/_comercial/empresas/$id')({
                  ...
                  <div className="flex flex-col gap-2 pb-6 w-full">
                    ...
                    <Card className="shadow-sm">
                      <CardHeader className="p-4 pb-2">
                        <CardTitle className="text-sm">Proposta Comercial - Venux ERP</CardTitle>
                      </CardHeader>
                      <CardContent className="p-4 pt-0 text-sm text-muted-foreground line-clamp-3">
                        Olá Marcos, tudo bem? Conforme conversamos, segue em anexo a nossa proposta comercial para a implementação do Venux ERP na Fazenda Citrosul...
                      </CardContent>
                    </Card>
                  </div>
                </div>
