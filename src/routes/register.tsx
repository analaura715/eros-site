...
export const Route = createFileRoute("/register")({
  head: () => ({ 
    meta: [
      { title: "Criar Conta | Nexa CRM" }, 
      { name: "description", content: "Crie sua conta no Nexa CRM." }
    ] 
  }),
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-[#F7F8FA]">
        ...
        >
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Email Corporativo</Label>
              <div className="relative group">
